if (msg.includes(" ")) {
  if (msg.includes(" stock")) {"/announceblue HolidayPresent " + nombre + " DROP DIXPER ! Dixper est actuellement désactivé, mais vous pouvez faire un stock de cartes pour pouvoir interagir avec le stream plus tard! https://dixper.gg/tarane96/drop/" + code + "?utm_source=dixper&utm_medium=drop&utm_campaign=drops-V1";}
